...
A **pyramid chart** shows data as parts of a pyramid. Pyramid charts can be segmented by either multiple measures or a single attribute.
Pyramid charts are useful to show hierarchies or workflows.


![Pyramid Chart Component](assets/pyramid_chart.png "Pyramid Chart Component")
