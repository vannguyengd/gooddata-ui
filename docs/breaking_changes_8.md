...
-  `@gooddata/react-components` is dissolved into the following packages:
    ...
    -  `@gooddata/sdk-ui-geo` contains components for Geo Pushpin Chart.
...
Repackaging. The new packages now have their own primary stylesheets.
...
We have removed several components in Version 8.0. Each removed component has a fully functional replacement.
...
For more information see [custom executions](50_custom__execution.md) page.
...
We have had the PivotTable component since Version 7.0. Feature-wise, PivotTable has all features of the legacy 
...
To adopt this change, change all uses of the Table component to the PivotTable component. To learn more about how to 
use the Pivot Table component, see the official documentation, live examples, or the code documentation.
...
To adopt this change,  use the catalog-export tool to generate the LDM (logical data model) object definitions for you. 
...
For more information, see the [catalog export](02_start__catalog_export.md) page.
...
Additionally, we deleted the columnMeasures prop and lineMeasures prop from the Combo Chart component. These props 
