...
![Funnel Chart Component](assets/funnel_chart.png "Funnel Chart Component")
...
The following example shows the supported `config` structure with sample values. For the description of the individual options, see [ChartConfig](15_props__chart_config.md).
