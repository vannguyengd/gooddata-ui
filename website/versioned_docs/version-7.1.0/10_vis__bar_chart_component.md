...
id: version-7.1.0-bar_chart_component
...
| stackBy | false | [Attribute](afm.md#attribute) | An attribute definition. Do not use `stackBy` in charts with multiple measures. |
